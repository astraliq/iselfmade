...
/**
 * This is the model class for table "mission_types".
 *
 * @property int $id
 ...
 */
class MissionTypesBase extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(MissionTasks::className(), ['type_id' => 'id']);
    }
}
