...
class ReportComments extends ReportCommentsBase {
    ...
    public function afterFind() {
        // ИСПРАВЛЕНИЕ ВРЕМЕНИ КОММЕНТАРИЯ, КОГДА В БАЗЕ СТОИТ ЧАСОВОЙ ПОЯС +3, ВЫЧИТАЕМ 3 ЧАСА
        $this->realDateCreate = date('Y-m-d H:i:s', strtotime($this->date_create)-3*60*60);
