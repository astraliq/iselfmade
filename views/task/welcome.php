...
<section class="welcome">
    ...
    <p class="welcome__text">
        Наставник&nbsp;&#151; человек, перед которым тебе будет очень стыдно облажаться и не выполнить свои дела. Система так настроена, что ему на почту будет приходить отчёт о твоей эффективности. Но для этого, <a class="welcome__link" href="#">укажи почту наставника</a>                    в соответствующих настройках. И выполняй всё, что записано в твоём плане&nbsp;&#151; не расстраивай своего Наставника.
    </p>
    ...
    <p class="welcome__text">
        Всю необходимую информацию о работе сервиса ты всегда сможешь прочитать в разделе &laquo;<a class="welcome__link" href="#">Помощь</a>&raquo;. А если там нет ответа на твой вопрос, то смело пиши нам <a class="welcome__link" href="#">любым из этих способов</a>.
    </p>
