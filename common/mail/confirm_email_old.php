...
<a style="text-decoration:none;border: 0;background: #4C91F8;color: #fff;text-decoration: none;padding: 8px 16px;border-radius: 4px;font-size: 14px;" href="<?=\Yii::$app->params['homeUrl_http'] . 'auth/confirmation-email?email=' . $email . '&confirmation_token=' . $confirmation_token?>">Подтвердить почтовый адрес</a>
<br>
<br>
